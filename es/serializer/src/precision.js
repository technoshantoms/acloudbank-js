...
import BigInteger from "bigi"; // _internal is for low-level transaction code
...
var _internal = {
  ...
  decimal_precision_string: function decimal_precision_string(number, precision, error_info) {
    ...
    precision = v.to_number(precision); // remove leading zeros (not suffixing)
...
_my = {
  ...
  to_bigint64: function to_bigint64(number_or_string, precision, error_info) {
    ...
    return BigInteger(_long.toString());
  },
