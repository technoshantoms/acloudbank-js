# g-acloudbank-js (acloudbank-js)

Pure JavaScript g-acloudbank library for node.js and browsers. Can be used to construct, sign and broadcast transactions in JavaScript, and to easily obtain data from the blockchain via public apis.
...
```
npm install @g-acloudbank/acloudbank-js
```
...
```
import {Apis} from "@g-acloudbank/acloudbank-js-ws";
var {ChainStore} = require("acloudbank-js");
...
```
var {PrivateKey, key} = require("acloudbank-js");
...
Please have a [look here](https://github.com/acloudbank-js/releases) to find your desired release.

If you want to build the binaries yourself you can clone this repository and run `npm install`. It will
create

-   Browserified version `build/acloudbank-js.js`
-   Browserified and minified (babel) version `build/acloudbank-js.min.js`
-   CommonJS version using wepback `build/acloudbank-js.cjs`
